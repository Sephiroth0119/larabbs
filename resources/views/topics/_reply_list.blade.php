    ...
    <div class="media-body">
      <div class="media-heading mt-0 mb-1 text-secondary">
        ...
        <span class="meta float-right ">
          <form action="{{ route('replies.destory',$reply->id) }}" onsbmit="return confirm('确定要删除此评论？');" method="POST">
            {{ csrf_field() }}
            {{ method_field('DELETE') }}
            <button type="submit" class="btn btn-default btn-cs pull-left text-secondary">
